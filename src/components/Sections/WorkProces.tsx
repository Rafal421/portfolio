...
export default function WorkProcess() {
  ...
  //   return (
  //     <div className="bg-[#1a1a1a] rounded-xl border border-[#2a2a2a] overflow-hidden shadow-xl min-h-[500px]">
  //       <div className="p-7">
  ...
  //             <div
  //               key={index}
  //               className="flex items-start space-x-3 bg-[#252525] p-3 rounded-lg"
  //             >
  //               <div className="w-8 h-8 rounded-lg bg-[#333333] flex items-center justify-center flex-shrink-0">
  //                 {step.icon}
  //               </div>
